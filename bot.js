    ...
    if (subcommand === 'create') {
      ...
      try {
        ...
        if (rollResult.total === rollResult.maxPossible) {
          ...
          gifUrl = 'https://raw.githubusercontent.com/Lonely6660/MultilandsRpgbot/refs/heads/main/reactions/Amazing.gif'; // local gif file
        } else if (rollResult.total >= 3) {
          resultText = '# **GREAT!!!** (Rolled a 3 or equivalent)';
          gifUrl = 'https://raw.githubusercontent.com/Lonely6660/MultilandsRpgbot/refs/heads/main/reactions/great.gif'; // local gif file
        } else if (rollResult.total === 2) {
          resultText = '# **GOOD!!** (Rolled a 2 or equivalent)';
          gifUrl = 'https://raw.githubusercontent.com/Lonely6660/MultilandsRpgbot/refs/heads/main/reactions/good.gif'; // local gif file
        } else {
          resultText = 'bleh... (Attack deflected or rolled a 1)';
          gifUrl = 'https://raw.githubusercontent.com/Lonely6660/MultilandsRpgbot/refs/heads/main/reactions/bleh....gif'; // local gif file
        }
